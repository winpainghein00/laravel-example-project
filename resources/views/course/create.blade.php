...
<body class="h-screen">
    <form action="{{ route('course.store') }}" method="POST">
        ...
        <a href="{{ route('course.index') }}" class="absolute rounded-full top-0 right-0 -m-1 hover:scale-125 hover:bg-white duration-200">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-7">
                <path stroke-linecap="round" stroke-linejoin="round" d="m9.75 9.75 4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
              </svg>
        </a>

            <h1 class="font-bold text-lg font-serif text-center mb-6">Course Create Form</h1>
            ...
            <div class="max-w-sm">
                ...
                <input type="number" id="student_limit" name="student_limit" value="{{ old('student_limit') }}"
                    class="border py-3 px-4 block w-full border-black rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600
                    @error('student_limit')
                    border-red-500
                    @enderror
                ...
                <div class="flex gap-x-6">
                    <div class="flex">
                        ...
                        <label for="hs-radio-group-1"
                            class="text-sm ms-2 dark:text-neutral-400">Open</label>
                    </div>
                    <div class="flex">
                        ...
                        <label for="hs-radio-group-2"
                            class="text-sm ms-2 dark:text-neutral-400">Close</label>
                    </div>
                </div>
            </div>
            <button type="submit"
