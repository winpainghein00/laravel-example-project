...
<body class="">
    <p class="md:hidden block p-2 bg-black text-white text-xs text-center">Please use your device in landscape mode for
        better experience</p>

    <div class="max-w-[1000px] mx-auto md:mt-5 mt-2 p-5 md:p-5">


        <div class="flex justify-between items-end ">
            <h1 class="font-bold font-serif text-xl">List of Students</h1>
        ...
        <div class="w-full flex flex-col border rounded-lg overflow-hidden">
                                    ...
                                    <tr class="hover:bg-gray-100 dark:hover:bg-neutral-700">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <div
                                                ...
                                                <a type="button" href="{{ route('student.show', $student->id) }}"
                                                ...
                                                <a href="{{route('student.edit',$student->id)}}" class="hover:scale-110 active:scale-100 duration-200">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
